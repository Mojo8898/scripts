...
def main():
    ...
    if lightweight:
        ...
        run_command(["sudo", "/usr/bin/nmap", "-Pn", "-n", "-p", "21,22,23,25,53,80,88,110,111,135,137,139,143,389,443,445,636,993,995,1433,2049,3306,3389,5900,5985,8080", "--open", "-oN", lightweight_tcp_file, ip])
    else:
